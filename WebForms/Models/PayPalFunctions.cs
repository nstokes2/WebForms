...
public class NVPAPICaller
{
    ...
    public string APIUsername = "nstokes2-facilitator_api1.memphis.edu";
    private string APIPassword = "NJKDCNNXBSYH6QYB";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31APqpcJf4tDcaYQidvzr-X1xjEQOr";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44376/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44376/Checkout/CheckoutCancel.aspx";
        ...
        using (WebForms.Logic.ShoppingCartActions myCartOrders = new WebForms.Logic.ShoppingCartActions())
        {
            List<CartItem> myOrderList = myCartOrders.GetCartItems();

            for (int i = 0; i < myOrderList.Count; i++)
            {
                encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].Animal.AnimalName.ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Animal.TicketPrice.ToString();
